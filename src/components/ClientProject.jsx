...
class ClientProject extends Component {
    ...
    render() { 
        return (
            <div>
                <h1 className='text-center'>My Client Project</h1>

                <div className=' container my-4 d-flex justify-content-center flex-wrap'>
                    <div className='col-sm-4 my-2'>
                        <h2 className=' container '>Web Design</h2>
                    ...
                    <div className='col-sm-4 my-5'>
                        <h2 className=' container'>{this.state.project}+ Projects</h2>
                    </div>
                ...
                <div className=' container d-flex justify-content-center flex-wrap'>
                    <div className='col-sm-4 my-2'>
                        <h2 className=' container '>App Design</h2>
                    ...
                    <div className='col-sm-4 my-5'>
                        <h2 className=' container'>{this.state.app}+ Projects</h2>
                    </div>
                ...
                <div className=' container my-4 d-flex justify-content-center flex-wrap'>
                    <div className='col-sm-4 my-3'>
                        <h2 className=' container '>DashBoard Design</h2>
                    ...
                    <div className='col-sm-4 my-5'>
                        <h2 className=' container'>{this.state.dashboard}+ Projects</h2>
                    </div>
